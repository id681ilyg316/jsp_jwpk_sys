...
<table class="table" cellspacing="1" cellpadding="2" width="80%" align="center" border="0">
  <tbody>
  <tr>
      <th class="bg_tr" align="center" colspan="7" height="25">班级管理</th>
  ...
  <tr>
   <td class="td_bg" align="left"  colspan="4" height="23">  
    ...
    <tr>
      ...
      <th class="bg_tr" align="center" width="350" colspan="2" height="25">操作</th>
    ...
    <% 
    	...
    	List<MyClass> list=MyClass.findAll(MyClass.class,"",new Object[]{},"id desc",limit,start*(size-1));
    	for(MyClass c:list){
      %>
    <tr>
      ...
      <a href="class_add.jsp?actionOption=update&id=<%=c.getId() %>" >修改</a></td>
      <td class="td_bg" align="center" height="23">
      <a href="class_temp.jsp?actionOption=delete&id=<%=c.getId() %>" >删除</a></td>
    </tr>
    <%}%>
    <tr>

...
%>
<form action="teacher_temp.jsp" method="POST">
<table class="table" cellspacing="1" cellpadding="2" width="80%" align="center" 
border="0">
  <tbody>
    <tr>
      <th class="bg_tr" align="left" colspan="2" height="25"><center>教师个人信息</center></th>
    </tr>
    ...
    <tr>
      ...
      <td class="td_bg" width="70%">
     		<select name="cate_name" value="${user.cate_name}">
     		   <%
     		 	List<Course> clist=Course.findAll(Course.class);
     		 	for(Course c:clist){
     		  %>
              	 <option selected="<%=m!=null?c.getC_name().equals(m.getCate_name()):"false" %>"><%=c.getC_name() %></option>
              	 <%  } %>
             </select>
      </td>
    </tr>
    ...
    <input name="u_type" type="hidden" value="teacher">
    <tr>

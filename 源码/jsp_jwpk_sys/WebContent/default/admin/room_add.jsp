...
<% 
		...
		Room m=Room.find(Room.class,id); 
		String action="save";
...
%>
<form action="room_temp.jsp" method="POST">
<table class="table" cellspacing="1" cellpadding="2" width="80%" align="center" 
border="0">
  <tbody>
    <tr>
      <th class="bg_tr" align="left" colspan="2" height="25"><center>教室管理</center></th>
    </tr>
    
    <tr>
      <td class="td_bg" width="20%" height="23">教室名称：</td>
      <td class="td_bg" width="70%">
     		 <input name="name" type="TEXT" size="14" value="${category.name}">
      </td>
    </tr>

...
<table class="table" cellspacing="1" cellpadding="2" width="80%" align="center" border="0">
  ...
  <tr>
    ...
    <% 
    	...
    	List<Project> list=Project.findAll(Project.class,"",new Object[]{},"id desc",limit,start);
    	for(Project c:list){
     %>
    <tr>
      ...
      <a href="student_list.jsp?class_id=<%=c.getMyclass().getId() %>" >班级学生</a>
      <a href="project_add.jsp?actionOption=update&id=<%=c.getId() %>" >成绩查询</a></td>
